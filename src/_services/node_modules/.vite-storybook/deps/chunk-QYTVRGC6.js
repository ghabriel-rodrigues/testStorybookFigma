...
var DocsRender = function() {
  ...
  _createClass5(DocsRender2, [{
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.next = 4;
                return import("./renderDocs-QIDB4FKX.js");
              case 4:
    ...
    key: "rerender",
    value: function() {
      var _rerender = _asyncToGenerator3(regeneratorRuntime.mark(function _callee3() {
        var _global$FEATURES2;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if ((_global$FEATURES2 = import_global5.default.FEATURES) !== null && _global$FEATURES2 !== void 0 && _global$FEATURES2.modernInlineRender) {
                  _context3.next = 3;
                  break;
                }
                _context3.next = 3;
...
//# sourceMappingURL=chunk-QYTVRGC6.js.map
