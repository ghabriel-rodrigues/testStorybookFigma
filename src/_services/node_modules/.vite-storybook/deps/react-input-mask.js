  ...
  "node_modules/react-input-mask/lib/react-input-mask.development.js"(exports, module) {
    ...
    var InputElement = function(_React$Component) {
      ...
      _proto.render = function render() {
        ...
        var inputElement;
        true ? warning(!restProps.maxLength || !parseMask(mask, maskChar, formatChars).mask, "react-input-mask: maxLength property shouldn't be passed to the masked input. It breaks masking and unnecessary because length is limited by the mask length.") : void 0;
        if (children) {
